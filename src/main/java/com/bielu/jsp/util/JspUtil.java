...
/**
 * <code>JspUtil</code> TODO provide description
 * 
...
public class JspUtil {
	...
	public static String copyrightDates(int startYear) {
	...
	public static String imageBaseUrl(Image img) {
		if (img.getDirectoryInfo().getCountryInfo() == null) {
			return "http://www.bielu.com/sycylia/zdjecia/";
		} else {
			return "http://www.bielu.com/azja/" + img.getDirectoryInfo().getCountryInfo().getDir();
		}
	}
}
