 ...
 */
public interface IStatisticsDao extends IDao<Statistics> {
	
	List<ValueBean> loadMethodStatistics();
	
	List<ValueBean> loadProtocolStatistics();

	List<ValueBean> loadSchemeStatistics();
	
	List<ValueBean> loadUserAgentStatistics(int limit);
	
	List<ValueBean> loadExecutionTimeStatistics();
}
