...
import com.bielu.dracul.www.domain.Statistic;
 ...
 */
public class StatisticDao extends Dao<Statistic> implements IStatisticDao {

	/**
	 * @{inheritDoc}
	 */
	public Statistic findById(long id) {
		return (Statistic) getHibernateTemplate().get(Statistic.class, new Long(id));
	}
	...
	public List<Statistic> loadAll() {
		return getHibernateTemplate().find("from " + Statistic.class.getName());
	}
}
